<template>
  <div class="grid grid-cols-1 lg:grid-cols-5 gap-8">
    <div ref="containerPokemons" class="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-4 lg:gap-8 lg:mb-0 mb-8">
      <pokemon-search />
      <pokemon-card-list v-for="(pokemon, p) in pokemons" :key="p" :name="pokemon.name" />
      <div class="mt-2 lg:mt-0 col-span-1 md:col-span-2 2xl:col-span-3 text-right">
